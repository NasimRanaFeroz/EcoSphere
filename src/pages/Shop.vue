...
import { Search, Filter, Grid, List, ShoppingCart, X, Plus, Minus } from "lucide-vue-next";
...
<template>
  <div class="container">
    ...
    <div class="cart-button-container">
      <button @click="cartStore.openCart()" class="cart-button">
    ...
    >
      <div class="cart-sidebar" @click.stop>
        <div class="cart-header">
          ...
          <button @click="cartStore.closeCart()" class="close-cart-btn">
            <X size="20" />
          </button>
        </div>
        ...
        <div v-if="cartStore.items.length > 0" class="cart-footer">
          ...
          <router-link to="/cart" @click="cartStore.closeCart()">
